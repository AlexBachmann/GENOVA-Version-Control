...
?>
<h1><?php echo JText::_('COM_VERSIONCONTROL_REVISIONS');?></h1>
...
<form action="<?php echo JRoute::_('index.php?option=com_gversioncontrol&view=revisions'.$this->getUrlExt());?>" method="post" name="adminForm" id="adminForm">
	<?php echo $this->loadTemplate('filters');?>
	<table class="adminlist revisions-table">
