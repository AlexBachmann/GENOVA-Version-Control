...
class GVersionControlControllerRevisions extends JControllerLegacy {
	...
	public function display($cachable = false, $urlparams = false){
		...
		if(!$context || !$item_id){
			$this->setRedirect(JRoute::_('index.php'), JText::_('COM_VERSIONCONTROL_NOTICE_SELECT_CONTEXT'));
			return;
		}
	...
	public function restore(){
		...
		if($model->restore($id)){
			...
			$this->setRedirect(JRoute::_('index.php?option=com_gversioncontrol&task=revisions.display'), JText::_('COM_VERSIONCONTROL_REVISIONS_RESTORE_FAILURE'), 'warning');
		}
	}
}